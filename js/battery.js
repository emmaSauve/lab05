...
// lab 5
// grab the img element from battery.html
const robohash = document.getElementById("robohash");
...
function updateBatteryStatus(battery) {
    ...
    //lab 5
    // get the robohash API and store it inside of a variable
    var robohashAPI = "https://robohash.org/";

    // store the chargerMeter value inside of a variable
    var chargeMeterValue = chargeMeter.value;

    // add the variables together and make that the image src
    robohash.src = robohashAPI + chargeMeterValue + "percent";
}
